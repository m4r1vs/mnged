		...
		return (
			<section class={style.signin}>
				<Card class={style.card + ' fadeIn'}>
					<h2>Register</h2>
					<p>
						Hi, welcome to MNGED! To create a new account chose between one of the following methods:
					</p>

					<center>

						<form onSubmit={this.signUpWithEmail.bind(this)}>
							<TextInput key="registerEmail" name="Your E-Mail" inputRef={(input) => this.signUpEmail = input} required />
							<TextInput key="registerPw" inputType="password" name="Create Password" inputRef={(input) => this.signUpPassword = input} required />
							<TextInput key="registerPwRepeat" inputType="password" name="Repeat Password" inputRef={(input) => this.signUpPasswordRepeated = input} required />
						...
						<div class={style.btnWrapper}>
							<DefaultButton onClick={() => this.signIn(facebookAuthProvider)} title="Register with Facebook" extraClass={style.thirdPartyButton} style={{ background: '#3b5998', marginLeft: '0' }}>
							...
							<DefaultButton onClick={() => this.signIn(googleAuthProvider)} title="Register with Google" extraClass={style.thirdPartyButton} style={{ background: '#d62d20' }}>
							...
							<DefaultButton onClick={() => this.signIn(twitterAuthProvider)} title="Register with Twitter" extraClass={style.thirdPartyButton} style={{ background: '#1da1f2' }}>
							...
							<DefaultButton onClick={() => this.signIn(githubAuthProvider)} title="Register with GitHub" extraClass={style.thirdPartyButton} style={{ background: '#4e277b' }}>
